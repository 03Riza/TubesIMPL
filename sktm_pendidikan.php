...
<div class="row" id="contentInput" >
          <div class="col-lg-12">
            <h1>Buat Surat Keterangan Tidak Mampu Pendidikan</h1>
            <ol class="breadcrumb">
              <li class="active">Pelayanan</li>
              <li class="active"> Buat SKTM Pendidikan</li>
            </ol>
          </div>
      </div>
<div class="container">
 ...
 <div class="row" id="contentJurusan">
                    <div class="col-lg-12">
                  <?php
                    $q="SELECT max(no_sktmPendidikan) as maxKode from tb_sktmpendidikan";   
        ...
        ?>
         <form  action="simpan_sktmpendidikan.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                  <div class="form-group form-group-sm">
              ...
              <div class="form-group form-group-sm">
               ...
               <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-4">
                    <input type="text" class="form-control" name="txtsekolah" id="txtsekolah" required>
                </div>
              </div>
               <div class="form-group form-group-sm">
                    <label class="control-label col-sm-3">Keterangan</label>
                    <div class="col-sm-4">
                    <textarea class="form-control" name="txtketerangan" cols="40" rows="5" id="txtketerangan" required ></textarea>
                </div>
              </div>
