...
if(isset($_GET['id'])){
  ...
  $id=($_GET['id']);
                      ...
                      $query="SELECT * FROM tb_permohonankia as p JOIN tb_penduduk as d ON p.nik=d.nik where no_permohonanKia='$id'";
                  	...
                  	echo"<script>alert('KIA Sudah Diambil')</script>";
...
<div class="row" id="contentInput" >
          <div class="col-lg-12">
            <h1> Pengambilan KIA</h1>
            <ol class="breadcrumb">
              <li class="active">Pelayanan</li>
              <li class="active">Pengambilan KIA</li>
            </ol>
          </div>
      </div>
<div class="container">
  ...
  require_once('koneksi.php');
       ...
       //Mengambil data dari form tambah staff
         ...
         $tg_ambil=mysqli_real_escape_string($koneksi,$_POST['txt_tglambil']);
          ...
          $perintah="UPDATE tb_permohonankia SET tgl_pengambilan='$tg_ambil', status='Sudah Diambil' WHERE no_permohonanKia='$nop'";
      ...
      if($aksi){
        ...
        echo"<br><a href='pengambilan_kia.php'>Kembali</a>";
