...
<div class="row" id="contentInput" >
          <div class="col-lg-12">
            <h1>Edit Surat Pindah</h1>
            <ol class="breadcrumb">
              <li class="active">Pelayanan</li>
              <li class="active"> Edit Surat Pindah</li>
            </ol>
          </div>
      </div>
<?php
...
if(isset($_GET['id'])){
  ...
  $id=($_GET['id']);
                      ...
                      $query="SELECT * FROM tb_ketpindah as p JOIN tb_penduduk as d ON p.nik=d.nik where no_ket='$id'";
...
<form  action="" class="form-horizontal" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-4">
                    <textarea class="form-control" name="txtket" cols="40" rows="5" id="txtket"><?php echo $data['ket'] ; ?></textarea>
                </div>
              </div>
              <div class="form-group form-group-sm">
...
<?php
  require_once('koneksi.php');
       ...
       $kett=mysqli_real_escape_string($koneksi,$_POST['txtket']);
         ...
         $tgl_per=mysqli_real_escape_string($koneksi,$_POST['txt_tglpermohonan']);
          ...
          $perintah="UPDATE tb_ketpindah SET nomor_kk='$nokk',tgl='$tgl_per',ket='$kett' WHERE no_ket='$nop'";
      ...
      if($aksi){
        ...
        echo"<br><a href='edit_suratpindah.php'>Kembali</a>";
