  ...
  require_once('koneksi.php');
       ...
       //Mengambil data dari form tambah staff
        ...
        $nik=mysqli_real_escape_string($koneksi,$_POST['txtnik']);
       	...
       	$perintah="INSERT INTO tb_permohonankia (no_permohonanKia,nik,jenisPermohonan,tgl_penyerahanBerkas,tglRekam,tgl_pengambilan,status) VALUES('$no','$nik','$jenis','$penyerahan','$rekam','','Belum Diambil')";
